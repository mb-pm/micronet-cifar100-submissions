...
This module is used for training candidate 1 which is a QuantBinSimpnet model.
The inputs of binary convolutions in this model are in 16 bits. Inputs to other
layers are in 32 bits.
...
from custom_layers import BinaryConv
...
if __name__ == '__main__':
    ...
    output_path = get_source_home_dir() / 'outputs/quant_bin_simpnet'
