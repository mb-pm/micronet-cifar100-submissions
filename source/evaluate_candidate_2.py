...
from custom_layers import KvantizationLayer
from model import BinaryConv
...
if __name__ == '__main__':
    ...
    source_dir = get_source_home_dir() / 'outputs/quant_bin_simpnet_plus'
    ...
    best_model = load_model(
        ...
        custom_objects={
            ...
            'KvantizationLayer': KvantizationLayer
        }
    )
